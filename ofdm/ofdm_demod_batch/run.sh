#!/bin/bash
# ofdm_demod_batch — generate + build + run + verify
set -e
...
echo "[run.sh] ofdm_demod_batch mode=${RUN_MODE} soc=${SOC_VERSION} batch=${BATCH_SIZE}"
python3 "${SCRIPT_DIR}/scripts/ofdm_demod_ref.py"
