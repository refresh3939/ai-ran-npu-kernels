...
extern "C" void GenerateTiling(const char *socVersion, uint8_t *buf)
{
    ...
    api.SetOrgShape(ofdm_mod_batch::M_MMAD, ofdm_mod_batch::Q, ofdm_mod_batch::K_PHASE1);
    api.SetShape(ofdm_mod_batch::M_MMAD, ofdm_mod_batch::Q, ofdm_mod_batch::K_PHASE1);
    api.SetBias(false);
    api.SetTraverse(MatrixTraverse::FIRSTM);
    api.SetFixSplit(ofdm_mod_batch::M_MMAD, ofdm_mod_batch::Q, -1);
