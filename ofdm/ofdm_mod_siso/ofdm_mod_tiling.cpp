...
extern "C" void GenerateTiling(const char *socVersion, uint8_t *buf)
{
    ...
    api.SetOrgShape(ofdm_mod::M_MMAD, ofdm_mod::Q, ofdm_mod::K_PHASE1);
    api.SetShape(ofdm_mod::M_MMAD, ofdm_mod::Q, ofdm_mod::K_PHASE1);
    api.SetBias(false);
    api.SetTraverse(MatrixTraverse::FIRSTM);
    api.SetFixSplit(ofdm_mod::M_MMAD, ofdm_mod::Q, -1);
