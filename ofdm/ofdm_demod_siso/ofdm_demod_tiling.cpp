...
extern "C" void GenerateTiling(const char *socVersion, uint8_t *buf)
{
    ...
    api.SetOrgShape(ofdm_demod::M_MMAD, ofdm_demod::Q, ofdm_demod::K_PHASE1);
    api.SetShape(ofdm_demod::M_MMAD, ofdm_demod::Q, ofdm_demod::K_PHASE1);
    api.SetBias(false);
    api.SetTraverse(MatrixTraverse::FIRSTM);
    api.SetFixSplit(ofdm_demod::M_MMAD, ofdm_demod::Q, -1);
